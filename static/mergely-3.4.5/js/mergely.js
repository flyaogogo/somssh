...
jQuery.extend(Mgly.CodeMirrorDiffView.prototype, {
	...
	bind: function(el) {
		...
		this.element.append(jQuery('<div class="col-md-6 col-sm-6 col-xs-6 column"><div class="mergely-margin" style="height: ' + height + '"><canvas id="' + this.id + '-lhs-margin" width="8px" height="' + height + '"></canvas></div>'
		+ '<div style="position:relative;width:' + width + '; height:' + height + '" id="' + this.id + '-editor-lhs" class="mergely-column"><textarea style="" id="' + this.id + '-lhs"></textarea></div>'
		+ '<div class="mergely-canvas" style="height: ' + height + '"><canvas id="' + this.id + '-lhs-' + this.id + '-rhs-canvas" style="width: 1px;" width="1px" height="' + height + '"></canvas></div></div>'));
		...
		// }
		this.element.append(jQuery('<div class="col-md-6 col-sm-6 col-xs-6 column"><div style="width:' + width + '; height:' + height + '" id="' + this.id + '-editor-rhs" class="mergely-column"><textarea style="" id="' + this.id + '-rhs"></textarea></div>'
		+ '<div class="mergely-margin" style="height: ' + height + '"><canvas id="' + this.id + '-rhs-margin" width="8px" height="' + height + '"></canvas></div></div>'));
		// if (this.settings.rhs_margin != 'left') {
		// 	this.element.append(rmargin);
		// }
